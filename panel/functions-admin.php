...
add_action( 'tgmpa_register', 'sporta_recommend_plugin' );
function sporta_recommend_plugin() {
 
    $plugins = array(
        // Include plugin from the WordPress Plugin Repository
		array(
			'name' 		=> 'WooCommerce', // http://wordpress.org/plugins/codepress-admin-columns/
			'slug' 		=> 'woocommerce',
			'required' 	=> false
		),
